...
# B동 학식 버튼
        ...
        if day_search() == 1:
            return JsonResponse(
                {
                    'message': {
			'text': today_date+"\nB동 학식\n\n점심(11:00 ~ 15:30)\n-----------------------------------------------\n"+"주전부리 요일특가"+today_menu(1)+"\n\n3,500원"+today_menu(2)+"\n\n3,900원"+today_menu(3)+"\n\n4,300원"+today_menu(4)+today_menu(5)+"\n\n4,800원"+today_menu(6)+today_menu(7)+"\n\n부찬"+today_menu(8)+"\n-----------------------------------------------"
		     },
                    'keyboard': {
                        'type': 'buttons',
                        'buttons': ['도움말', 'A동 학식(교직원 식당)', 'B동 학식', '신기숙사(새로암학사) 식당', '구기숙사(두루암학사) 식당', '내일 메뉴']
...
# 내일 B동 학식 버튼
        ...
        if next_search() == 1:
            return JsonResponse(
                {
                    'message': {
		        'text': tomorrow_date+"\nB동 학식\n\n점심(11:00 ~ 15:30)\n-----------------------------------------------\n"+"주전부리 요일특가"+tomorrow_menu(1)+"\n\n3,500원"+tomorrow_menu(2)+"\n\n3,900원"+tomorrow_menu(3)+"\n\n4,300원"+tomorrow_menu(4)+tomorrow_menu(5)+"\n\n4,800원"+tomorrow_menu(6)+tomorrow_menu(7)+"\n\n부찬"+tomorrow_menu(8)+"\n-----------------------------------------------"
                     },
                    'keyboard': {
                        'type': 'buttons',
                        'buttons': ['도움말', '내일 A동 학식(교직원 식당)', '내일 B동 학식', '내일 신기숙사(새로암학사) 식당', '내일 구기숙사(두루암학사) 식당', '뒤로']
